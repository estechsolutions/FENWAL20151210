 ...
 */
public class InternalSelectSegment_F3291 extends ValueObject implements Serializable {

    private InternalGetWhereFields_F3291  queryWhereFields = new InternalGetWhereFields_F3291();
    ...
    public void setQueryWhereFields(InternalGetWhereFields_F3291 queryWhereFields) {
        this.queryWhereFields = queryWhereFields;
    }

    public InternalGetWhereFields_F3291 getQueryWhereFields() {
    ...
    public InternalResults_F3291 getQueryResults(int i) {
        if (this.queryResults != null && this.queryResults.size()>i){
            return (InternalResults_F3291) queryResults.get(i);
        }else{
            return null;
        }
    }    
